...
<p>另一个体会是「统一」这件事要克制。我前期想做「大而全」，结果第一个版本做了 80+ 模块，60% 没人用。后来砍到 30+ 核心模块，反而每个都做得更扎实。这点我后来在技术文章里专门写过：<a href="/blog/2025/01/15/enterprise-microservice-platform/">《企业级微服务基础平台怎么设计》</a>。</p>
</div>
</div>
...
<p>另外「CPU / GPU / NPU 三套部署方案」这个设计一开始我也觉得过度设计，后来发现不同项目现场的基础设施差异巨大（有的现场有 GPU 服务器、有的只有边缘盒子、有的连工控机都算奢侈品），不做适配就根本无法推广。这块的经验我专门写过一篇：<a href="/blog/2026/02/10/yolov5-object-detection/">《YOLOv5 目标识别实践》</a>。</p>
</div>
</div>
...
<p>另外 Dify 这种 Workflow 工具很好用，但不能解决所有问题。复杂业务逻辑必须用 LangChain / Python 写代码。我后来专门写过：<a href="/blog/2025/10/15/text-to-sql-practice/">《气量智能问数：Dify + LangChain / Text-to-SQL 实战》</a>，里面有更详细的踩坑记录。</p>
...
<p>这块的细节我后来在 <a href="/blog/2024/08/30/go-libvirt-vm-management/">《Go + KVM / libvirt 虚拟机管理实践》</a> 里专门写过一篇文章。</p>
</div>
</div>
</div>
...
<div class="proj-note">
<b>说明</b>：项目页面只列了主要负责的项目。其他涉及政府 / 能源 / 运营商行业的项目受保密协议约束不便公开，更多细节在简历 PDF 中（<a href="/blog/downloads/gaoxiaozhuang-resume.pdf">下载 PDF</a>）。<br>
